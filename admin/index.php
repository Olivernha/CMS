...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            $comment_unapproved_counts=checkStatus('posts','post_status','unapproved');
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            $element_count=[$post_counts,$post_publish_counts,$post_draft_counts,$comment_counts,$comment_unapproved_counts,$user_counts, $subscriber_counts,$category_counts];
